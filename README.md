...
<sub>Full guide [here](https://learn.microsoft.com/en-us/azure/api-management/api-management-configuration-repository-git#deploy-service-configuration-changes-to-the-api-management-service-instance)</sub>
